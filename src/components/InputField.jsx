...
const InputField = ({
  ...
  value,
  className = "",
  onChange, // Added to handle mutable fields
}) => (
  <div className={`w-full ${className}`}>
    ...
    <div
      className={`inline-flex leading-6 items-center relative mt-1 w-full p-5 rounded-md border border-solid border-white/5 ${
        disabled
          ? "bg-[#0b1d33]/40 text-[#6587b0]/70"
          : "bg-[#0b1d33] text-[#6587b0]"
    ...
    >
      <input
        ...
        readOnly={disabled} // Add readOnly when disabled to silence warning
